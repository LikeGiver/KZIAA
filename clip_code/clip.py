...
if __name__ == "__main__":
    ...
    # model, clip_state_dict = load('/home/yushui/mc2/wuxun/wuxun/temporal_sentence_grounding/zero-shot-TSG/clip_based_zero_shot_TSG/clip/checkpoints/ViT-B-32.pt', 
    ...
    model, clip_state_dict = load('checkpoints/ViT-B-32.pt', 
                device="cuda", jit=False, tsm=False, T=8, dropout=0.0 , emb_dropout=0.0 ,pretrain=True, joint = False) #Must set jit=False for training  ViT-B/32
